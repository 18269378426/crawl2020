...
class KafkaPipeline(object):
    ...
    def from_crawler(cls, crawler):
        ...
        ext.producer = KafkaProducer(bootstrap_servers=['120.78.247.150:9094'], compression_type='gzip', value_serializer=lambda v: json.dumps(dict(v), default=str).encode('utf-8'))
        return ext
